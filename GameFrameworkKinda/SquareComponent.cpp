...
SquareComponent::SquareComponent(Game* g) : GameComponent(g), offset()
{
...
void SquareComponent::Initialize()
{
	...
	auto res = D3DCompileFromFile(L"./QuadShader.hlsl",
		nullptr /*macros*/,
		nullptr /*include*/,
		"VSMain",
		"vs_5_0",
	...
	res = D3DCompileFromFile(L"./QuadShader.hlsl",
...
void SquareComponent::SetPosition(DirectX::SimpleMath::Vector2 pos)
{
	offset.x = pos.x;
	offset.y = pos.y;
}

void SquareComponent::SetY(float y)
{
	offset.y = y;
}

void SquareComponent::SetX(float x)
{
	offset.x = x;
}

float SquareComponent::GetX() const
{
	return offset.x;
}

float SquareComponent::GetY() const
{
	return offset.y;
}

DirectX::SimpleMath::Vector2 SquareComponent::GetPosition() const
{
